"""
Скрипт для инициализации начальных данных
Запустите этот файл один раз для создания places.json
"""

import json
import os

# Данные о местах (из оригинального script.js)
places = [
    {
        "id": 1,
...
# Сохраняем данные о местах
with open('data/places.json', 'w', encoding='utf-8') as f:
    json.dump(places, f, ensure_ascii=False, indent=2)

print("✅ Файл data/places.json успешно создан!")
